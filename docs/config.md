...
To specify pre-existing databases for tools, add the path to the fields in the **`Included data/resources`** and the **`Databases`** sections of the `nextflow.config` file or include the following on the command line.By default, the databases will be stored in `data/db_*`.

| Parameter                 | Description                                                                   | Type   | Default                                      | Notes                                                                            |
| :------------------------ | :---------------------------------------------------------------------------- | :----- | :------------------------------------------- | :------------------------------------------------------------------------------- |
| `--db_dir`                | Path to directory containing downloaded databases                             | path   | "data/"                                      | Change this path to the location of downloaded databases                         |
| `--resource_dir`          | Path to directory containing included data resources                          | path   | "data/"                                      | Change this path to the folder of data included in this repository               |
| `--pointfinder_orgs`      | StarAMR PointFinder organism list for antimicrobial resistance gene detection | path   | "data/pointfinder_organism.tsv"              | Included in this repository                                                      |
| `--chroquetas_orgs`       | ChroQueTas species list for antimicrobial resistance mutation detection       | path   | "data/chroquetas_organism.tsv"               | Included in this repository                                                      |
| `--emmtyper_db`           | emmtyper database for emm typing in Streptococcus pyogenes                    | path   | "data/db_emmtyper/emm_types_20250131.fasta"  | Included in this repository                                                      |
| `--kmerresistance_db_arg` | KmerResistance ResFinder antimicrobial resistance database                    | string | "data/db_kmerresistance/resfinder_v2.4.0"    | Included in this repository                                                      |
| `--kmerresistance_db_spp` | KmerResistance KMA species placeholder database                               | string | "data/db_kmerresistance/species_placeholder" | Included in this repository                                                      |
| `--genomesize_key`        | Key file with average genome size for each bacterial/fungal genus in NCBI     | path   | "data/ncbi_genus_size.tsv"                   | Included in this repository                                                      |
| `--cge_key`               | CGE phenotype key file for KmerResistance antimicrobial resistance detection  | path   | "data/cge_key_20240612_phenotypes.txt"       | Included in this repository                                                      |
| `--clsi_key`              | CLSI organism key file for reportable antimicrobial phenotype                 | path   | "data/clsi_key.txt"                          | Included in this repository                                                      |
