...
12. `spp_staph_samples.tsv`: a list of _Staphylococcus aureus_ samples for toxin detection (file will be empty if no _Staphylococcus aureus_ detected)
