...
wget http://faust.compbio.cs.cmu.edu/sylph-stuff/gtdb-r220-c200-dbv1.syldb -N -P ${INSTALL_DIR}/db_sylph

wget http://faust.compbio.cs.cmu.edu/sylph-stuff/fungi-refseq-2024-07-25-c200-v0.3.syldb -N -P ${INSTALL_DIR}/db_sylph
...
wget https://zenodo.org/records/14320496/files/gtdb_r220_metadata.tsv.gz -N -P ${INSTALL_DIR}/db_sylph-tax

wget https://zenodo.org/records/14320496/files/fungi_refseq_2024-07-25_metadata.tsv.gz -N -P ${INSTALL_DIR}/db_sylph-tax
